...
def generate():
    ...
    Label(cp, text='File Saved!', bg='#FFFC00' , fg='black', font=('Arial Black', 8)).pack()
...
Label(frame, text='File Name(Save As) : ', font=('Arial Black', 16),
      bg='#FFFC00').grid(row=1, column=0, sticky='w')
